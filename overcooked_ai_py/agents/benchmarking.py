...
class AgentEvaluator(object):
    ...
    This class currently only fully supports fixed mdps, or variable mdps that can be created with the LayoutGenerator class,
    ...
    def take_traj_indices(trajs, indices):
        ...
        # Make metadatas field into additional keys for trajs, rather than having a metadatas field?
