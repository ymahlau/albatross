...
class OvercookedGridworld(object):
    ...
    clean the organization of this class further.
    """
    ...
    def get_state_transition(self, state, joint_action, display_phi=False, motion_planner=None):
        ...
        dist_reward: float = self.calculate_distance_based_shaped_reward(state, new_state)
        shaped_reward_by_agent[0] += dist_reward
        shaped_reward_by_agent[1] += dist_reward
    ...
    def calculate_distance_based_shaped_reward(self, state, new_state):
        ...
        nearly_ready_pots = cooking_pots + pot_states["1_items"] + pot_states["2_items"] + pot_states["3_items"]
        ...
        for player_old, player_new in zip(state.players, new_state.players):
            ...
            if player_new.held_object is not None and player_new.held_object.name == 'dish' \
